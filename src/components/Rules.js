      ...
      {toggleRules &&
        <div className="mt-3 px-2">
          ...
          <ol>
            ...
            <li>2. Once everyone is in the same room, click Start. <span className="text-xs italic">During the game, you can only type when it is your turn. Write the next sentence of the story, but you can only see the previous sentence!</span></li>
